...
module.exports = function (context, req) {
    ...
    /*
    var azureWebsiteName = "change";
    var subscriptionId = "change";
    var uName = "change";
    var tenantId = "change";
    var graphAccessToken = "change";
    */
    ...
    /*
    context.log("-- CSP INPUTS --");
    context.log(azureWebsiteName);
    ...
    */
    ...
    context.bindings.res = {      
        oTenantId: tenantId,  
        oAzureWebsiteName: azureWebsiteName,
        oSubscriptionId: subscriptionId,
        oUserId: userId,
        oGraphAccessToken: graphAccessToken,
