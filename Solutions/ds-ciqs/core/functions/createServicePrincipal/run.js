...
// This Azure Function creates a service principal for the application and,
// if necessary, assigns an 'owner' role to it under the Subscription
...
// -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// ADAPTED CODE - from 'pcs-cli' TypeScript -> JavaScript
// -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
// This function orchestrates the actual creation of the Service Principal and
// returns an object with required values
// Largely taken from 'pcs-cli' code, converted to plain JavaScript
...
// This function assigns the 'owner' role to the service principal under the Subscription
